# Name: mk/lib.mk - library for Makefile
...
src_root := /mnt/beegfsnew/data
dst_root := /data

lpath := $(src_root)

remote := $(project)
bucket := bocconi-hpc-backup
...
mail_From := $(project) system <hpc-backup@unibocconi.it>
mail_from := hpc-backup@unibocconi.it
mail_To   := $(project) admin <hpc-backup@unibocconi.it>
#mail_to   := hpc-backup@unibocconi.it
#mail_to   := argia.rubeo@unibocconi.it \
#             massimo.materazzi@unibocconi.it \
#             marco.broglia@mutex.it
             marco.broglia@mutex.it
